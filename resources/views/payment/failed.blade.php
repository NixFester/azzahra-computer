...
@section('title', 'Pembayaran Gagal — Azzahra Computer')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8">
                    <div class="result-card failed-card">
                        ...
                        <h1 class="result-title">Pembayaran {{ $order->status === 'expired' ? 'Kedaluwarsa' : 'Gagal' }}</h1>
                        ...
                        <div class="order-summary">
                            ...
                            <div class="summary-row">
                                ...
                                <span class="summary-value amount-failed">Rp{{ number_format($order->amount, 0, ',', '.') }}</span>
                            </div>
                            <div class="summary-divider"></div>
                            <div class="summary-row">
                                ...
                                <span class="status-badge status-failed">
                                    ...
                                    {{ $order->status === 'expired' ? 'Kedaluwarsa' : 'Gagal' }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="result-actions">
                            @if($order->xendit_invoice_url && $order->status !== 'expired')
                                <a href="{{ $order->xendit_invoice_url }}" class="btn-result btn-retry-result">
                                    <i class="bi bi-arrow-clockwise me-2"></i>Coba Bayar Lagi
                                </a>
                            @endif
                            <a href="{{ route('product.detail', $order->product_id) }}" class="btn-result btn-primary-result">
                                <i class="bi bi-bag me-2"></i>Pesan Ulang
                            </a>
                            <a href="{{ route('products') }}" class="btn-result btn-outline-result">
