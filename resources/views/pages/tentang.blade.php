    ...
    <section class="container py-5">
        ...
        <div class="row align-items-center mb-5">
            ...
            <div class="col-md-5 mb-4 mb-md-0">
                <img src="images/kantor.jpg" alt="Kantor Azzahra Computer" class="img-fluid rounded shadow">
        ...
        <div class="row justify-content-center mb-5">
            <div class="col-md-8 col-lg-7">
                <iframe src="https://www.google.com/maps?q=Komplek+Ruko+Citraland+Tegal&output=embed" width="100%"
                    height="300" style="border:0;" loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                </iframe>
            </div>
        </div>
