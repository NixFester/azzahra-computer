    ...
    <div class="container-fluid">
                        ...
                        <div class="position-absolute top-0 end-0 p-2">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <form action="{{ route('admin.iklan.destroy', $banner) }}" method="POST"
            ...
            @if ($banners->count() < 4)
                <div class="col-md-6">
                    <a href="{{ route('admin.iklan.create') }}?type=banner" class="text-decoration-none">
                        <div class="card border-0 shadow-sm h-100 bg-light d-flex align-items-center justify-content-center"
        ...
        <div class="row g-3">
            @foreach ($promos as $promo)
                <div class="col-3">
                    <div class="card border-0 shadow-sm h-100 position-relative">
                        <img src="{{ $promo->image_url }}" class="card-img-top h-100" alt="{{ $promo->title }}"
                        ...
                        <div class="position-absolute top-0 end-0 p-2">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <form action="{{ route('admin.iklan.destroy', $promo) }}" method="POST"
                                            onsubmit="return confirm('Yakin ingin menghapus?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="dropdown-item text-danger"><i
            ...
            <div class="col-3">
                <a href="{{ route('admin.iklan.create') }}?type=promo" class="text-decoration-none">
                    <div class="card h-100 border-0 shadow-sm h-100 bg-light d-flex align-items-center justify-content-center"
            ...
            <div class="row g-3 mb-5">
                @foreach ($brands as $brand)
                    <div class="col-md-4">
                        <div class="card border-0 shadow-sm h-100 position-relative">
                            <img src="{{ $brand->image_url }}" class="card-img-top" alt="{{ $brand->title }}"
                            ...
                            <div class="position-absolute top-0 end-0 p-2">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <form action="{{ route('admin.iklan.destroy', $brand) }}" method="POST"
                                                onsubmit="return confirm('Yakin ingin menghapus?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="dropdown-item text-danger"><i
