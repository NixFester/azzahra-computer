                ...
                <tr>
                    ...
                    <td>
                        @if ($produk->image_array)
                            <img src="{{ Storage::url($produk->image_array) }}" 
                                 alt="Product Image" 
                                 class="rounded" 
                    ...
                    <td>{{ $produk->brand ?? '-' }}</td>
                    <td class="fw-semibold text-primary">Rp. {{ number_format($produk->price * 1000, 2, ',', '.') ?? '-' }}</td>
                    <td>
                ...
                <tr>
                    <td colspan="7" class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <p class="mt-2 mb-0">
                                @if(request('search'))
                                    Tidak ada produk yang ditemukan dengan kata kunci "<strong>{{ request('search') }}</strong>"
                                @else
