                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="product_name"
                                    ...
                                    value="{{ old('product_name') }}" required placeholder="Masukkan nama produk">
                                @error('product_name')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="category"
                                        ...
                                        value="{{ old('category') }}" required placeholder="Contoh: Elektronik">
                                    @error('category')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="brand"
                                        ...
                                        value="{{ old('brand') }}" placeholder="Contoh: Samsung">
                                    @error('brand')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
